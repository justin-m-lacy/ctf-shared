...
import { MatchEnd } from '../ctf/team-won';
...
export declare function unionToMessageContent(type: MessageContent, accessor: (obj: FlagDropped | FlagReturned | FlagTaken | PlayerCancelFire | PlayerChargeFire | PlayerFire | PlayerKilled | PlayerMove | PlayerRespawn | TeamScored | MatchEnd) => FlagDropped | FlagReturned | FlagTaken | PlayerCancelFire | PlayerChargeFire | PlayerFire | PlayerKilled | PlayerMove | PlayerRespawn | TeamScored | MatchEnd | null): FlagDropped | FlagReturned | FlagTaken | PlayerCancelFire | PlayerChargeFire | PlayerFire | PlayerKilled | PlayerMove | PlayerRespawn | TeamScored | MatchEnd | null;
export declare function unionListToMessageContent(type: MessageContent, accessor: (index: number, obj: FlagDropped | FlagReturned | FlagTaken | PlayerCancelFire | PlayerChargeFire | PlayerFire | PlayerKilled | PlayerMove | PlayerRespawn | TeamScored | MatchEnd) => FlagDropped | FlagReturned | FlagTaken | PlayerCancelFire | PlayerChargeFire | PlayerFire | PlayerKilled | PlayerMove | PlayerRespawn | TeamScored | MatchEnd | null, index: number): FlagDropped | FlagReturned | FlagTaken | PlayerCancelFire | PlayerChargeFire | PlayerFire | PlayerKilled | PlayerMove | PlayerRespawn | TeamScored | MatchEnd | null;
